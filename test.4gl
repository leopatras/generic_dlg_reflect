...
#+ note this is a test, reading RECORD/ARRAY values in application specific code
#+ using reflect is nonsense
#+ making use of it in a library is a different thing
